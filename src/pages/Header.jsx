  ...
  return (
    <header className="w-full bg-white shadow-md fixed top-0 left-0 z-20">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-3">
        {/* Logo (solo imagen fija) */}
        <img src={logo} alt="UKÖ Bread" className="h-12" />
        ...
        <div
          ...
          className="flex items-center gap-2 cursor-pointer bg-black text-white px-4 py-2 rounded-full hover:bg-gray-800 transition"
        >
          {/* Ícono usuario en SVG */}
          <svg
