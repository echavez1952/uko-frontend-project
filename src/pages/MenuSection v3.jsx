...
export const MenuSection = () => {
  ...
  const handleSelectProduct = async (product) => {
    ...
    try {
      ...
      // Ordenar: primero con imagen, luego sin imagen
        ...
        <div>
          ...
          {loadingItems ? (
            ...
            <div
              ...
              style={{ maxHeight: "70vh" }} // scroll vertical limitado
            >
              {items.map((item) => (
                <div
                  key={item._id}
                  className={`border rounded-lg shadow-md p-4 flex flex-col items-center ${item.image ? "h-auto" : "h-40"
                    }`}
                >
                  {item.image ? (
                    <img
                    ...
                    <div className="h-20 w-20 bg-gray-200 flex items-center justify-center rounded mb-3 text-gray-500 text-sm">
                      Sin imagen
                    </div>
                  )}
